...
angular.module('bw.paging', []).directive('paging', function () {
    ...
    function fieldTemplate(el, attrs) {
        return '<ul data-ng-hide="Hide" data-ng-class="ulClass" class="custom-paginator-main-ul"> ' +
            '<li ' +
            'title="{{Item.title | translate}}" ' +
            'data-ng-class="Item.liClass" class="custom-paginator-item-li"' +
            'data-ng-repeat="Item in List"> ' +
            '<a ' +
            (attrs.pgHref ? 'data-ng-href="{{Item.pgHref}}" ' : 'href ') +
            'data-ng-class="Item.aClass" class="custom-paginator-item-a"' +
